...
public final class Config
{
	...
	private Config()
	{
		...
		try {
			...
			itemStacksNamesToIgnore = Arrays.asList(config.getStringList("itemStacksNamesToIgnore", general, new String[]{}, "Put here itemstacks that you want to ignore/not unify.\nExample Format: minecraft:iron_ingot#0"));
