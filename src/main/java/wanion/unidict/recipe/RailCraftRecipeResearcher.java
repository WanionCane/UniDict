...
public class RailCraftRecipeResearcher extends AbstractRecipeResearcher<ShapedRailcraftRecipe, ShapelessRailcraftRecipe> {
    @Override
    public int getShapedRecipeKey(@Nonnull ShapedRailcraftRecipe recipe) {
    ...
    @Override
    public int getShapelessRecipeKey(@Nonnull ShapelessRailcraftRecipe recipe) {
        final TIntList recipeKeys = Util.getList(recipe.recipeItems, resourceHandler);
        int recipeKey = 0;
        recipeKeys.sort();
        for (final TIntIterator recipeKeysIterator = recipeKeys.iterator(); recipeKeysIterator.hasNext(); )
    ...
    @Nonnull
    @Override
    public List<Class<? extends ShapedRailcraftRecipe>> getShapedRecipeClasses() {
        return Collections.singletonList(ShapedRailcraftRecipe.class);
    }

    @Nonnull
    @Override
    public List<Class<? extends ShapelessRailcraftRecipe>> getShapelessRecipeClasses() {
        return Collections.singletonList(ShapelessRailcraftRecipe.class);
    }

    @Override
    public ShapedOreRecipe getNewShapedRecipe(@Nonnull final ShapedRailcraftRecipe recipe) {
    ...
    @Override
    public ShapedOreRecipe getNewShapedFromShapelessRecipe(@Nonnull final ShapelessRailcraftRecipe recipe) {
        final List<Ingredient> recipeInputs = recipe.getIngredients();
    ...
    @Override
    public ShapelessOreRecipe getNewShapelessRecipe(@Nonnull final ShapelessRailcraftRecipe recipe) {
    ...
    @Override
    public ShapelessOreRecipe getNewShapelessFromShapedRecipe(@Nonnull final ShapedRailcraftRecipe recipe) {
        final List<Object> inputs = new ArrayList<>();
        if (itemStacksOnly) {
